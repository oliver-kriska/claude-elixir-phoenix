...
> **Source of truth: `iron-laws/laws.yaml`**. Edit there, then run
> `make port` to regenerate the section below. Do not edit between the
> `IRON-LAWS-BEGIN` and `IRON-LAWS-END` markers — changes will be overwritten.
