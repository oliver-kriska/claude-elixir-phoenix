...
description: Run project-aware verification loop. Reads mix.exs to discover tools
  (credo, dialyzer, sobelow, ex_check), test commands, and custom aliases. Use proactively
  after code changes.
model: haiku
mode: subagent
skills:
