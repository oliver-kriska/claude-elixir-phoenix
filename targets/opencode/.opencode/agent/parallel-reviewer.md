...
description: Parallel code review using 4 specialist agents (elixir-reviewer, security-analyzer,
  testing-reviewer, verification-runner). Use for thorough review of significant changes.
model: opus
mode: subagent
skills:
- elixir-idioms
