---
name: xref-analyzer
description: Analyze module dependencies and context boundaries using mix xref. Use
  proactively before major refactors or when reviewing architectural changes.
model: haiku
mode: subagent
skills:
- boundaries
