...
description: Cross-check implementation against task requirements (Linear issue, GitHub
  issue, plan, spec). Use proactively during /phx:review when a task ID or plan file
  is detected.
model: sonnet
mode: subagent
---
