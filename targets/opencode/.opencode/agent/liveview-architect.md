...
description: LiveView architecture specialist - component structure, real-time patterns,
  streams vs assigns, async patterns. Use proactively when planning interactive features.
model: sonnet
mode: subagent
skills:
- liveview-patterns
