...
```
$elixir-phoenix:phx-compound Fixed N+1 query in UserListLive — was missing preload on posts
```
...
- `$elixir-phoenix:phx-learn-from-fix` captures quick patterns in `common-mistakes.md`
- `$elixir-phoenix:phx-compound` captures detailed solutions with full context
- `$elixir-phoenix:phx-investigate` searches `.claude/solutions/` before investigating
- `$elixir-phoenix:phx-plan` consults for known risks in planned areas
