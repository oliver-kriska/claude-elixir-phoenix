...
Detailed methodology for the research phase of `$elixir-phoenix:phx-brainstorm`.
...
## Integration with $elixir-phoenix:phx-plan

When `$elixir-phoenix:phx-plan` detects `.claude/plans/{slug}/interview.md` with research:
