---
name: phx-deps-audit
description: Audit Hex deps for supply-chain risk — bidi, compile-time exec, typosquats,
  CVEs. Use after mix deps.update or on mix.lock diffs.
metadata:
  effort: medium
  argument-hint: '[--base <ref> | --preview [pkg...]] [--quick] [--json] [--sarif
    <path>] [--ci] [--strict] [--no-differential] [--no-llm | --llm] [--trace]'
