...
Re-run after fix: `$elixir-phoenix:phx-deps-audit`
Inspect one package: `$elixir-phoenix:phx-deps-audit --preview req`
Compare against main: `$elixir-phoenix:phx-deps-audit --base origin/main`
