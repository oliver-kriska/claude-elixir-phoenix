...
Authoritative pacing for `$elixir-phoenix:phx-deps-audit`. The SKILL.md "Execution Flow"
...
```
$elixir-phoenix:phx-deps-audit          ← runs the full pipeline
$elixir-phoenix:phx-deps-audit --base main
$elixir-phoenix:phx-deps-audit --preview httpoison
```
...
```
$elixir-phoenix:phx-deps-audit --quick
```
