...
Detailed methodology for the research phase of `/skill:phx-brainstorm`.
...
## Integration with /skill:phx-plan

When `/skill:phx-plan` detects `.claude/plans/{slug}/interview.md` with research:
