...
- `/skill:phx-plan` — Create a plan from these findings (recommended for 3+ fixes)
- `/skill:phx-quick` — Apply top priority fix directly (1-2 simple fixes)
- `/skill:phx-investigate` — Deep-dive into a specific finding
```
