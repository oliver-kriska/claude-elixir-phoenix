...
/skill:phx-review lib/my_app/accounts.ex  # Elixir idioms
...
/skill:phx-investigate Login failing after password reset
...
/skill:phx-plan Add daily digest email job
...
/skill:phx-review lib/my_app_web/controllers/session_controller.ex
...
| "Is my context design idiomatic?" | Plugin's `/skill:phx-review` |
