...
- **Long sessions** — `/skill:phx-work` or `/skill:phx-full` hitting context limits from mix output
- **Debugging loops** — `/skill:phx-investigate` retrying `mix compile`/`mix test` repeatedly
