...
```
/skill:phx-compound Fixed N+1 query in UserListLive — was missing preload on posts
```
...
- `/skill:phx-learn-from-fix` captures quick patterns in `common-mistakes.md`
- `/skill:phx-compound` captures detailed solutions with full context
- `/skill:phx-investigate` searches `.claude/solutions/` before investigating
- `/skill:phx-plan` consults for known risks in planned areas
