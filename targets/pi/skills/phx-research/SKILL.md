...
- "Plan a feature based on this research" → `/skill:phx-plan`
- "Investigate a specific finding" → `/skill:phx-investigate`
- "Research more on a subtopic" → continue research
- "Done" → end

**NEVER auto-invoke `/skill:phx-plan` or any other skill after research.**
