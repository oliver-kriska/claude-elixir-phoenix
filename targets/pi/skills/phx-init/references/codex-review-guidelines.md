...
<!-- Last updated: {DATE} | Managed by /skill:phx-init — edits inside markers are overwritten on --update -->
...
- Re-running `/skill:phx-init --update` refreshes the block in place.
