...
```
/skill:phx-work  # Resume at first unchecked non-[BLOCKED] task; stop if an earlier blocker exists
```

### From Specific Task

```
/skill:phx-work .claude/plans/auth/plan.md --from P2-T3
```
...
```
/skill:phx-work .claude/plans/auth/plan.md --skip-blockers
```
