...
const workflows: Workflow[] = [
  {
    "category": "ecto",
    "title": "constraint-debug",
    "skillName": "ecto-constraint-debug",
  ...
  },
  {
    ...
    "argumentHint": "path/to/live_view.ex"
  },
  {
    "category": "phx",
    "title": "audit",
    ...
    "argumentHint": "[--quick|--full|--focus=area|--since=commit]"
  },
  {
    "category": "phx",
    "title": "boundaries",
    "skillName": "phx-boundaries",
    ...
    "argumentHint": "[--assess|--fix]"
  },
  {
    "category": "phx",
    "title": "brainstorm",
    "skillName": "phx-brainstorm",
    ...
    "argumentHint": "<topic or feature idea>"
  },
  {
    "category": "phx",
    "title": "brief",
    ...
    "argumentHint": "[path to plan file]"
  },
  {
    "category": "phx",
    "title": "challenge",
    "skillName": "phx-challenge",
    ...
    "argumentHint": "ecto | liveview | pr"
  },
  {
    "category": "phx",
    "title": "codex-loop",
    "skillName": "phx-codex-loop",
    ...
    "argumentHint": "[--base <branch>] [--uncommitted] [--auto] [--max-rounds N]"
  },
  {
    "category": "phx",
    "title": "compound",
    "skillName": "phx-compound",
    ...
    "argumentHint": "[description of what was fixed]"
  },
  {
    "category": "phx",
    "title": "deploy",
  ...
  },
  {
    ...
    "argumentHint": "[--base <ref> | --preview [pkg...]] [--quick] [--json] [--sarif <path>] [--ci] [--strict] [--no-differential] [--no-llm | --llm] [--trace]"
  },
  {
    "category": "phx",
    "title": "deps-update",
    "skillName": "phx-deps-update",
    ...
    "argumentHint": "[--scope patch|minor|major|all] [--pkg <name>...] [--pr-per major|area|none] [--dry-run]"
  },
  {
    "category": "phx",
    "title": "deps-vet",
    "skillName": "phx-deps-vet",
    ...
    "argumentHint": "<pkg> <version> | --seed | --list | --check"
  },
  {
    "category": "phx",
    "title": "document",
    "skillName": "phx-document",
    ...
    "argumentHint": "[plan-file OR feature-name]"
  },
  {
    "category": "phx",
    "title": "examples",
    "skillName": "phx-examples",
  ...
  },
  {
    "category": "phx",
    "title": "freeze",
    "skillName": "phx-freeze",
    "description": "Apply an advisory edit scope in this session. Use for read-only or directory-scoped work; no enforcement hook is installed.",
    "argumentHint": null
  },
  {
    "category": "phx",
    "title": "full",
    "skillName": "phx-full",
    "description": "Run a portable sequential plan-work-verify-review-compound lifecycle. Use optional generic workers only when Amp makes them available.",
  ...
  {
    "category": "phx",
    "title": "hexdocs-fetcher",
    "skillName": "hexdocs-fetcher",
  ...
  },
  {
    ...
    "argumentHint": "[--section N]"
  },
  {
    "category": "phx",
    "title": "investigate",
    "skillName": "phx-investigate",
    "description": "Investigate Elixir/Phoenix bugs root-cause first. Reproduce failures, cite evidence, and use optional Amp subagents only when useful.",
    "argumentHint": "<bug description> [--parallel]"
  },
  {
    "category": "phx",
    "title": "learn-from-fix",
    "skillName": "phx-learn-from-fix",
    ...
    "argumentHint": "[--library <hex-package> --scope personal|project] <lesson>"
  },
  {
    "category": "phx",
    "title": "mix-compression",
    "skillName": "phx-mix-compression",
  ...
  },
  {
    ...
    "argumentHint": "[file_path | directory | --all]"
  },
  {
    "category": "phx",
    "title": "perf",
    ...
    "argumentHint": "[page|context|module] [--focus ecto|liveview|otp]"
  },
  {
    "category": "phx",
    "title": "permissions",
    "skillName": "phx-permissions",
  ...
  },
  {
    ...
    "argumentHint": "<feature description OR path to review/plan file>"
  },
  {
    "category": "phx",
    "title": "pr-review",
    "skillName": "phx-pr-review",
    ...
    "argumentHint": "<PR number or URL> [--fix] [--bots-only] [--no-resolve]"
  },
  {
    "category": "phx",
    "title": "quick",
  ...
  },
  {
    ...
    "argumentHint": "<question about past work>"
  },
  {
    "category": "phx",
    "title": "research",
    "skillName": "phx-research",
  ...
  },
  {
    "category": "phx",
    "title": "review",
    "skillName": "phx-review",
    "description": "Review changed Elixir/Phoenix code read-only. Check requirements, cite evidence, deduplicate findings, and return a severity-based verdict.",
    "argumentHint": "[test|security|oban|deploy|iron-laws|all]"
  },
  {
    "category": "phx",
    "title": "techdebt",
    "skillName": "phx-techdebt",
  ...
  },
  {
    ...
    "argumentHint": "[path to review file]"
  },
  {
    "category": "phx",
    "title": "verify",
    "skillName": "phx-verify",
  ...
  },
  {
    "category": "phx",
    "title": "watch-pr",
    "skillName": "phx-watch-pr",
    "description": "Watch an Elixir/Phoenix PR with an Amp Orb keep-alive lease until required non-deployment CI is green and review threads are resolved.",
    "argumentHint": "<PR number or URL> [--checks-only] [--fix]"
  },
  {
    "category": "phx",
    "title": "work",
...
const investigationTracks: InvestigationTrack[] = [
  {
    "key": "reproduction",
    "label": "Reproduction track",
    "instructions": "Reproduce or precisely characterize the reported Elixir/Phoenix failure. Find the narrowest deterministic trigger, expected versus actual behavior, and concrete logs/tests/code evidence. Do not diagnose beyond the evidence."
  },
  {
    "key": "root-cause",
    "label": "Root-cause track",
    "instructions": "Trace the failing Elixir/Phoenix path from entry point to the first state or contract divergence. Distinguish root cause from downstream symptoms and cite path:line evidence for every conclusion."
  },
  {
    "key": "impact",
    "label": "Impact track",
    "instructions": "Map the confirmed or plausible blast radius of the reported failure across callers, data, users, security boundaries, and regressions. Separate verified impact from unverified risk and cite path:line evidence."
  },
  {
    "key": "fix-strategy",
    "label": "Fix-strategy track",
    "instructions": "Propose the smallest correct Elixir/Phoenix fix for the reported failure, plus the focused regression test and verification needed. Do not edit. State what must be verified before implementation and cite path:line evidence."
  }
]
