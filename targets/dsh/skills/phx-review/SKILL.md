...
Native DeepSeek Harness subagents may run independent read-only concern tracks in parallel.
...
- `references/agent-spawning.md` — DeepSeek Harness concern selection and optional parallelism
