...
Usage:
    python merge-findings.py .claude/xray/layers/
    python merge-findings.py .claude/xray/layers/ --output merged.json
...
def main():
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Directory containing layer .md files (e.g., .claude/xray/layers/)",
    )
    parser.add_argument(
        "--output",
        default=None,
