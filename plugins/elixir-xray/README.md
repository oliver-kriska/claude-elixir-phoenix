...
Install the plugin, run `/xray:scan` on your project, get concrete improvements you can apply immediately.

```
/xray:scan              # Standard analysis (~50 findings, 10 min)
/xray:scan --deep       # Deep: 20 sub-agents, 100+ findings (~20 min)
/xray:scan --gate measure  # Create quality baseline for CI
/xray:apply             # Generate Credo checks, skills, CI scripts
```
...
/plugin install elixir-xray

# Or local development
claude --plugin-dir ./plugins/elixir-xray
```
