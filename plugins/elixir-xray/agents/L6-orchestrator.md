...
description: |
  ...
  analyzer, and growth predictor. Used by /xray:scan --deep.
...
- **Primary**: `.claude/xray/layers/architecture.json`
...
- `.claude/xray/layers/L6/boundary-validation.md`
- `.claude/xray/layers/L6/coupling-analysis.md`
- `.claude/xray/layers/L6/growth-prediction.md`
...
Write `.claude/xray/layers/L6/consolidated.md` with:
...
- Sub-agent fails → log to `.claude/xray/layers/L6/errors.log`, continue with remaining
...
```
You are a specialist analyzer for Elixir X-Ray Layer 6.
