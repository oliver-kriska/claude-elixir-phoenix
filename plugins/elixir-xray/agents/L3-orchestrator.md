...
description: |
  Deep Layer 3 orchestrator for X-Ray. Spawns 6 specialist sub-agents to analyze
  code patterns, naming, boundaries, feature flags, error handling, and test gaps.
  Used by /xray:scan --deep. Returns consolidated findings.
...
5. Write individual results to `.claude/xray/layers/L3/{name}.md`
6. Deduplicate findings about the same topic across sub-agents
7. Write `.claude/xray/layers/L3/consolidated.md`
...
You are a specialist analyzer for Elixir X-Ray Layer 3.
...
- `.claude/xray/layers/L3/naming-conventions.md` (L3a)
- `.claude/xray/layers/L3/domain-boundaries.md` (L3b)
- `.claude/xray/layers/L3/pattern-consistency.md` (L3c)
- `.claude/xray/layers/L3/feature-flags.md` (L3d)
- `.claude/xray/layers/L3/error-handling.md` (L3e)
- `.claude/xray/layers/L3/test-coverage-gaps.md` (L3f)
...
Write `.claude/xray/layers/L3/consolidated.md`:
...
- Sub-agent fails → log to `.claude/xray/layers/L3/errors.log`, continue with rest
