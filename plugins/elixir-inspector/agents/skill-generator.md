...
description: |
  Generate Claude Code skills from Inspector findings.
...
Generate project-specific Claude Code skills from Inspector findings.
...
3. Write to `.claude/inspector/generated/skills/{skill-name}/SKILL.md`
...
One directory per skill in `.claude/inspector/generated/skills/`, each with a SKILL.md.
