...
description: |
  Interpret pre-computed .claude/ configuration data for Inspector Layer 4.
...
- **No CLAUDE.md**: check for AGENTS.md, README.md, or other config docs
...
- **Gaps**: patterns in code not captured in any documented rule
