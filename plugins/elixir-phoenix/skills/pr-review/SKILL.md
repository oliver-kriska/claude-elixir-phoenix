---
name: phx:pr-review
description: Respond to PR review comments and feedback from OTHER reviewers on Elixir/Phoenix code. Use when the user says "I got review comments on my PR", shares a PR URL to respond to, needs to address reviewer feedback, or a reviewer flagged an issue (like N+1 queries) to fix. Retrieves comments, drafts responses, and optionally fixes code. NOT for reviewing your own code (use review) or challenging code (use challenge).
effort: high
